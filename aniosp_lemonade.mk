...
# Inherit some common AniOSP stuff.
$(call inherit-product, vendor/aniosp/config/common_full_phone.mk)

PRODUCT_NAME := aniosp_lemonade
...
# Make it an official build
ANIOSP_BUILD_TYPE := OFFICIAL
